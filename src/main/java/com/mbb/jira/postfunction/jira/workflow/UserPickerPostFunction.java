...
public class UserPickerPostFunction extends AbstractJiraFunctionProvider
{
    ...
    public void copyUserPicker(MutableIssue issue, String fromCustomFieldName, String toCustomFieldName) {
        CustomField copyFrom = (CustomField) customFieldManager.getCustomFieldObjectsByName(userPickerFrom);
        //CustomField copyTo = (CustomField) customFieldManager.getCustomFieldObjectsByName(userPickerFrom);
        copyFrom.getValue(issue);

        //copyTo.getCustomFieldValues()
    }
}